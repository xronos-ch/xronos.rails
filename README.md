...
Administrative command-line tasks for maintenance, cleanup, cache updates, and controlled record deletion are documented in [`docs/admin-cli.md`](docs/admin-cli.md).
