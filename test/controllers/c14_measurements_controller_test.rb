...
class C14MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create c14_measurement" do
    assert_difference('C14Measurement.count') do
      post c14_measurements_url, params: { c14_measurement: { bp: @c14_measurement.bp, delta_c13: @c14_measurement.delta_c13, delta_c13_std: @c14_measurement.delta_c13_std, method: @c14_measurement.method, std: @c14_measurement.std } }
    end
  ...
  test "should update c14_measurement" do
    patch c14_measurement_url(@c14_measurement), params: { c14_measurement: { bp: @c14_measurement.bp, delta_c13: @c14_measurement.delta_c13, delta_c13_std: @c14_measurement.delta_c13_std, method: @c14_measurement.method, std: @c14_measurement.std } }
