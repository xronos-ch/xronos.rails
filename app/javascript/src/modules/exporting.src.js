...
extend(Chart.prototype, {
	 ...
	 */	
	 getSVG: function(additionalOptions) {
		...
		options.yAxis = [];
    //Achsen nach aktuellem Stand neu setzen
		each(chart.yAxis, function (yAxis) {
		  extremes=yAxis.getExtremes();
		  axisOptions =yAxis.options;
   		axisOptions.min=extremes.min;
   		axisOptions.max=extremes.max;
      options.yAxis.push(axisOptions);
		}
		);
		options.series = [];
