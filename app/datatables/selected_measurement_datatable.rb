    ...
    records.map do |record|
      {
        ...
        "period": record.period_name, #Period.where(:id => record.period_id).pluck(:name).join(', '),
        "typochronological_unit": best_in_place(TypochronologicalUnit.find(record.typochronological_unit_id), :name),
        "ecochronological_unit": best_in_place(EcochronologicalUnit.find(record.ecochronological_unit_id), :name),
